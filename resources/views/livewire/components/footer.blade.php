        ...
        <div class="row">
            @if (!empty($profile))
                ...
                @if (!empty($profile['facebook'] && $profile['show_facebook'] ?? false))
                    <li>
                        <a class="text-decoration-none" href="{{ $profile['facebook'] }}" target="_blank"
                            ><i class="bi bi-facebook display-6 text-light px-4"></i
                        ></a>
                    </li>                    
                @endif
                @if (!empty($profile['twitter'] && $profile['show_twitter'] ?? false))
                    <li>
                        <a class="text-decoration-none" href="#"
                            ><i class="bi bi-twitter-x display-6 text-light px-4"></i
                        ></a>
                    </li>                    
                @endif
                @if (!empty($profile['instagram'] && $profile['show_instagram'] ?? false))
                    <li>
                        <a class="text-decoration-none" href="#"
                            ><i class="bi bi-instagram display-6 text-light px-4"></i
                        ></a>
                    </li>                                    
                @endif
                @if (!empty($profile['pinterest'] && $profile['show_pinterest'] ?? false))
                    <li>
                        <a class="text-decoration-none" href="#"
                        ><i class="bi bi-pinterest display-6 text-light px-4"></i
                        ></a>
                    </li>                                    
                @endif
            </ul>
...
<footer class="bg-primary mt-5" style="height: 150px">
