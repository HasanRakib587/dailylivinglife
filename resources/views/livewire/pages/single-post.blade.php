            ...
            <div class="row g-5 justify-content-center my-5">
                ...
                <div class="col-md-6 my-5 mx-auto">
                    ...
                    <div class="tags">
                        ...
                        <p>
                            <a class="text-decoration-none text-secondary" href="https://www.facebook.com/profile.php?id=61561551233074" target="_blank">
                            ...
                            <a class="text-decoration-none text-secondary" href="https://x.com/dailylivinglif3" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><path fill="currentColor" d="M10.488 14.651L15.25 21h7l-7.858-10.478L20.93 3h-2.65l-5.117 5.886L8.75 3h-7l7.51 10.015L2.32 21h2.65zM16.25 19L5.75 5h2l10.5 14z"/></svg>
                            </a>
                            <a class="text-decoration-none text-secondary" href="https://www.instagram.com/yourdailylivinglife/?hl=en" target="_blank">
                            ...
                            <a class="text-decoration-none text-secondary" href="https://www.pinterest.com/jashimhi5/" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><path fill="currentColor" d="M9.04 21.54c.96.29 1.93.46 2.96.46a10 10 0 0 0 10-10A10 10 0 0 0 12 2A10 10 0 0 0 2 12c0 4.25 2.67 7.9 6.44 9.34c-.09-.78-.18-2.07 0-2.96l1.15-4.94s-.29-.58-.29-1.5c0-1.38.86-2.41 1.84-2.41c.86 0 1.26.63 1.26 1.44c0 .86-.57 2.09-.86 3.27c-.17.98.52 1.84 1.52 1.84c1.78 0 3.16-1.9 3.16-4.58c0-2.4-1.72-4.04-4.19-4.04c-2.82 0-4.48 2.1-4.48 4.31c0 .86.28 1.73.74 2.3c.09.06.09.14.06.29l-.29 1.09c0 .17-.11.23-.28.11c-1.28-.56-2.02-2.38-2.02-3.85c0-3.16 2.24-6.03 6.56-6.03c3.44 0 6.12 2.47 6.12 5.75c0 3.44-2.13 6.2-5.18 6.2c-.97 0-1.92-.52-2.26-1.13l-.67 2.37c-.23.86-.86 2.01-1.29 2.7z"/></svg>
                            </a>
                        </p>
                    </div>
                </div>
